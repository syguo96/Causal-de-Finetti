function [gns] = nonsta_cd_new(X,cond_ind_test,c_indx,maxFanIn,alpha, Type, pars)
...
if(Type==0)
    ...
    for i = 1:length(cmodule_id)
        ...
        [Yg,Yl,Mg,Ml,D,eigValueg,eigValuel] = cd_non_con_fun(X(:,pa_id),X(:,x_id),c_indx,pars.width,pars.if_GP2);
        Yg_save{i} = Yg;
        Yl_save{i} = Yl;
